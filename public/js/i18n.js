...
export const STR = {
  ...
  mode_creative: 'קריאייטיב',
  lobbyTitle_creative: 'לובי — קריאייטיב',
  mapSaved: '💾 המפה נשמרה!',
  mapLoaded: '📂 המפה נטענה ({n} חלקים)',
  mapCleared: '🧹 המפה נוקתה',
  map_island: 'האי שלי',
  mode_tactical: 'טקטי',
  tacScore: 'מתקפה {a} : {b} הגנה',
  tacPrep: 'היכונו…',
  tacLive: 'הסבב התחיל!',
  tacRound: 'סבב {n}',
  planting: '⏳ שותל…',
  defusing: '✂️ מפרק…',
  bombPlanted: '💣 הפצצה הונחה!',
  roundWon: 'ניצחתם את הסבב!',
  roundLost: 'הפסדתם את הסבב',
  tacWin: 'ניצחון! 🏆',
  tacLose: 'הפסד',
  ...
  secAudio: '🔊 שמע',
  secDisplay: '🖥️ תצוגה וגרפיקה',
  fov: 'שדה ראייה (FOV)',
  quality: 'איכות גרפיקה',
  quality_low: 'נמוכה',
  quality_medium: 'בינונית',
  quality_high: 'גבוהה',
  sfxVol: 'עוצמת אפקטים',
  musicVol: 'עוצמת מוזיקה',
  secBinds: '🎯 מיפוי כפתורי שלט',
  secKb: '⌨️ מיפוי מקלדת',
  pressKey: 'לחצו מקש…',
  resetKb: 'איפוס מקלדת לברירת המחדל',
  act_fwd: 'קדימה',
  act_back: 'אחורה',
  act_left: 'שמאלה',
  act_right: 'ימינה',
  act_material: 'החלפת חומר',
  ...
  act_pick: 'מכוש',
  act_edit: 'עריכה',
  act_gun: 'החלף נשק/בנייה',
  act_slotPrev: 'נשק/חומר קודם',
  act_slotNext: 'נשק/חומר הבא',
  act_camera: 'מצלמה',
  act_emote: 'ריקוד',
