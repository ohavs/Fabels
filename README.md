...
3. **דרך א' (הכי קלה) — לינק הזמנה:** שחקן אחד בוחר מצב ← בלובי לוחץ **🔗 הזמינו חברים** ← הלינק מועתק (או נפתח חלון שיתוף) ← שולחים בוואטסאפ ← החבר לוחץ ונכנס **ישר לחדר**.
4. **דרך ב' — קוד חדר:** בלובי מוצג קוד בן 5 תווים ← החברים מקלידים אותו ב"הצטרפות עם קוד" בתפריט.
5. **דרך ג' — שידוך:** כולם לוחצים על אותו מצב באותו זמן ומצטרפים אוטומטית לאותו חדר.
6. המארח בוחר מפה, רמת בוטים (**0 = רק שחקנים**) ואם החדר **פרטי** (מוסתר מהשידוך — כניסה בלינק/קוד בלבד) ← "התחל קרב".
